...
class LMKExtractor():
    def __init__(self, FPS=25):
        ...
        base_options = python.BaseOptions(model_asset_path=os.path.join(_CUR_DIR, 'mp_models/face_landmarker_v2_with_blendshapes.task'))
        ...
        det_base_options = python.BaseOptions(model_asset_path=os.path.join(_CUR_DIR, 'mp_models/blaze_face_short_range.tflite'))
